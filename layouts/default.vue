...
<template>
  <div>
    ...
    />
    <SuccessDialog
      v-model="uiStore.successDialog.show"
      :title="uiStore.successDialog.title"
      :message="uiStore.successDialog.message"
      @close="uiStore.closeSuccess"
    />
    <InfoDialog
      v-model="uiStore.infoDialog.show"
      :title="uiStore.infoDialog.title"
      :message="uiStore.infoDialog.message"
      @close="uiStore.closeInfo"
    />
