export default [
  ...
  { type: 'link', title: 'Pengguna', icon: 'ri-user-line', to: '/master-data/users' },
  { type: 'link', title: 'Warga', icon: 'ri-group-line', to: '/master-data/warga' },
  { type: 'link', title: 'Regu', icon: 'ri-team-line', to: '/master-data/regu' },
  { type: 'link', title: 'Informasi Iuran', icon: 'ri-file-list-line', to: '/master-data/informasi-iuran' },
