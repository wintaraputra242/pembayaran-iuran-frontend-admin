  ...
  <div class="mt-n5">
    ...
    <template v-else>
      <div class="mb-4">
        ...
        <p class="text-body-1">
          Isi form berikut untuk membuat pembayaran baru.
        </p>
      </div>

      <FormCreatePembayaran
        :is-clear-form="isClearForm"
        :month-paid-warga="pembayaranStore.monthPaidPaymentWarga"
        ...
        :dropdown-warga-options="dropdownStore.itemWargaForPembayaran"
        :loading-submit="pembayaranStore.loading"
        @submit="handleCreatePembayaran"
        @get-month-paid="handleGetMonthPaid"
      />
