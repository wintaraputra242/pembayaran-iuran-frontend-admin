...
<template>
  <div>
    ...
    <VRow>
      ...
      <VCol cols="12">
        <VCard color="error" variant="tonal" rounded="lg" class="pa-4 cursor-pointer"
      ...
      <VCol cols="12">
        ...
        <VRow dense>
          ...
          <VCol cols="6">
            <VBtn color="error" variant="flat" block size="small" rounded="lg" prepend-icon="ri-user-unfollow-line"
              @click="router.push('/pembayaran/cek-belum-bayar')">
              Siapa Belum Bayar
            </VBtn>
          </VCol>
          <VCol cols="6">
            <VBtn color="warning" variant="flat" block size="small" rounded="lg" prepend-icon="ri-time-line"
          ...
          <VCol cols="6">
            <VBtn color="info" variant="flat" block size="small" rounded="lg" prepend-icon="ri-file-add-line"
              @click="showFormIuran = true">
              Tambah Iuran
            </VBtn>
          </VCol>
          <VCol cols="6">
            <VBtn color="primary" variant="flat" block size="small" rounded="lg" prepend-icon="ri-notification-line"
