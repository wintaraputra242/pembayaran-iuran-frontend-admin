...
const getFontSizeClass = (value: number) => {
  ...
  if (length > 16)
    return 'text-caption' // misal Rp 100.000.000 ke atas
  if (length > 12)
    return 'text-body-2' // misal Rp 10.000.000 - 99.999.999
...
<template>
  <div>
    ...
    <VRow>
      ...
      <VCol cols="12">
        <VCard
          ...
          variant="tonal"
          rounded="lg"
          class="pa-4 pa-md-5 cursor-pointer"
      ...
      >
        <VCard
          rounded="lg"
          class="h-100"
          style="border-top: 3px solid rgb(var(--v-theme-success));"
        >
          <VCardText class="pa-4">
            <div class="d-flex align-center justify-space-between mb-3">
              <VAvatar
              ...
              <span
                class="font-weight-black text-success text-end text-truncate"
                :class="getFontSizeClass(dashboardStore.totalPembayaranHariIni)"
                style="max-width: 75%;"
              >
      ...
      >
        <VCard
          ...
          style="border-top: 3px solid rgb(var(--v-theme-warning));"
        ...
        >
          ...
          >
            <VBtn
              ...
              class="quick-action-btn"
              @click="router.push('/pembayaran/cek-belum-bayar')"
            >
              Siapa Belum Bayar
            </VBtn>
          </VCol>
          ...
          >
            <VBtn
              ...
              class="quick-action-btn"
              @click="router.push('/pembayaran/cek-belum-validasi')"
            >
              Validasi Pembayaran
            </VBtn>
          </VCol>
          ...
          <VCardItem class="pb-0">
            ...
            <div class="d-flex flex-wrap gap-2 mt-3">
              <VChip
                ...
                :key="f.value"
                :color="selectedType === f.value ? 'primary' : 'default'"
                :variant="selectedType === f.value ? 'flat' : 'tonal'"
                size="small"
                :prepend-icon="f.icon"
        ...
        <VCardText class="pa-4">
          <div class="d-flex justify-end gap-2">
            ...
            <VBtn
              ...
              @click="pembayaranStore.submitCancel('dashboard')"
            >
              <VIcon
                icon="ri-close-circle-line"
                class="me-1"
    ...
    <DialogFormDataInformasiIuran
      ...
      :loading-dropdown-warga="dropdownStore.loading.wargaForDropdown"
      @close="showFormIuran = false"
