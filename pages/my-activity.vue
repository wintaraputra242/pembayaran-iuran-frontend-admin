...
<template>
  <div>
        ...
        <VRow align="center">
          ...
          >
            <DatePicker
              ...
              placeholder="Filter tanggal bayar"
              :enable-time="false"
              range
              clearable
            />
    ...
    <!-- Tabel -->
    <DataTableRiwayatKetua
      :data="pembayaranStore.riwayatKetuaRegu"
      :loading="pembayaranStore.loadingRiwayatKetua"
      :has-more="!!pembayaranStore.metaRiwayatKetua?.next_page_url"
