...
<template>
  ...
  >
    ...
    <template
      v-if="props.type === 'pembayaran'"
      #cell-judul_iuran="{ item }"
    >
    ...
    >
      <div
        v-if="item.status_bayar === 'pending'"
        class="d-flex gap-1"
      >
      ...
      <template v-else-if="item.status_bayar === 'rejected'">
        <div
          v-ripple
          v-tooltip="'Klik untuk lihat alasan penolakan'"
