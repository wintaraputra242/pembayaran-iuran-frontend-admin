...
watch(() => props.initialStatusAktif, val => {
  filters.status_aktif = val ?? null
})
watch(() => props.initialJenisIuran, val => {
  filters.jenis_iuran = val ?? null
})
      ...
      <VRow align="center">
        ...
        >
          <VTextField
            ...
            placeholder="Cari informasi iuran"
