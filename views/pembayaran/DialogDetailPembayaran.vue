...
const bulanLabel = computed(() => {
  if (!detail.value?.bulan || !Array.isArray(detail.value.bulan))
    return null
...
const buktiPembayaranUrl = computed(() => {
  if (!detail.value?.bukti_pembayaran)
    return null
      ...
      >
        ...
        <div v-else-if="detail">
          <div class="d-flex align-center justify-space-between mb-4">
            ...
            <VChip
              :color="getStatusConfig(detail.status_bayar).color"
              size="small"
              label
              variant="text"
          ...
          >
            <tbody>
              ...
              <tr>
                ...
                <td class="font-weight-medium text-capitalize">
                  {{ detail.jenis_iuran }}
                </td>
              </tr>
              <tr v-if="bulanLabel">
