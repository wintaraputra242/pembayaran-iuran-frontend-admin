...
const rules = {
  ...
  gambar: (v: File | null) => {
    if (!props.isEdit && !v)
      return 'Gambar QRIS wajib diupload'
      ...
      <VCardItem>
        ...
        >
          <VRow class="pt-1">
            ...
            <VCol cols="12">
              <VTextField
                v-model="params.nama_rekening"
                label="Nama Rekening"
                placeholder="Contoh: Kas RT 01"
            ...
            <VCol cols="12">
              ...
              <div
                v-if="previewUrl"
                class="d-flex flex-column align-center gap-2 mb-3"
              >
                <img
                  :src="previewUrl"
              ...
              <div
                v-else
                class="dropzone d-flex flex-column align-center justify-center ga-2 cursor-pointer"
