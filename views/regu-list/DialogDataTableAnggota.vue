...
const checkLeaderIsAvailable = dataDummy.filter(item => item.status === 'Ketua Regu').length > 0
...
const dropdownItemsWarga = dataDummy.map(item => item.nama)
      ...
      <VCardText class="pb-0 py-1">
        <div class="d-flex justify-end flex-wrap gap-2">
          ...
          <VBtn
            ...
            variant="flat"
            color="error"
            @click="emit('resetAnggota', dataDummy)"
          >
            <VIcon
              ...
              >
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td align="center">
                      <VChip
                        :color="item.status === 'Ketua Regu' ? 'info' : ''"
                    ...
                    <td>
                      <div class="d-flex gap-2">
                        <div style="width: 34px;">
                          <IconBtn
                            v-if="item.status !== 'Ketua Regu' && checkLeaderIsAvailable"
                            variant="outlined"
                            class="rounded-lg"
                            size="small"
                            color="secondary"
                            @click="emit('changeLeader', item)"
                          >
                            <VIcon icon="ri-loop-left-line" />
                          </IconBtn>
                        </div>
                        <IconBtn
                          v-if="!checkLeaderIsAvailable"
                          variant="outlined"
                          class="rounded-lg"
                          size="small"
                          color="secondary"
